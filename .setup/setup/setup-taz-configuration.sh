...

{
    ...
    tsocmd "PERMIT DFHDB2.AUTHTYPE.DBD1 CLASS(FACILITY) ID(${ZOS_USER}) ACCESS(READ)"
    ...
    tsocmd "PERMIT DFHDB2.AUTHTYPE.${APP_BASE_NAME} CLASS(FACILITY) ID(${ZOS_USER}) ACCESS(READ)"
