...
CREATE STOGROUP BANKZACC  VOLUMES('*','*','*','*','*') VCAT DBD1;
CREATE TABLESPACE ACCOUNT IN BANKZ USING STOGROUP BANKZACC;
...
CREATE UNIQUE INDEX BANKZ.ACCTINDX
  ...
  USING STOGROUP BANKZACC;

CREATE INDEX BANKZ.ACCTCUST
   ON BANKZ.ACCOUNT(ACCOUNT_SORTCODE,ACCOUNT_CUSTOMER_NUMBER)
   USING STOGROUP BANKZACC;

CREATE STOGROUP BANKZPROC VOLUMES('*','*','*','*','*') VCAT DBD1;
CREATE TABLESPACE PROCTRAN IN BANKZ USING STOGROUP BANKZPROC;
...
CREATE STOGROUP BANKZCONT VOLUMES('*','*','*','*','*') VCAT DBD1;
CREATE TABLESPACE CONTROL IN BANKZ USING STOGROUP BANKZCONT;
...
CREATE UNIQUE INDEX BANKZ.CONTINDX
 ...
 USING STOGROUP BANKZCONT;

CREATE STOGROUP BANKZCUST VOLUMES('*','*','*','*','*') VCAT DBD1;
CREATE TABLESPACE CUSTOMER IN BANKZ USING STOGROUP BANKZCUST;
